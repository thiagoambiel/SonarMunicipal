        ...
        <header className="topbar">
          <Link className="brand" href="/">
            ...
            <div>
              ...
              <p className="brand-subtitle">Metodologia e confiabilidade</p>
            </div>
          </Link>
          <nav className="nav">
            <div className="nav-links">
              ...
              <span className="nav-link active">Metodologia</span>
            </div>
        ...
        <main className="page-body">
          ...
          <section className="info-grid">
            ...
            <div className="info-card">
              ...
              <p>
                Indicadores reais calibram o efeito médio. A janela de impacto é múltipla da periodicidade do
                indicador.
              </p>
              <ul className="muted small">
            ...
            <div className="info-card">
              ...
              <p>
                Mantemos o link para o texto original e para o indicador usado. Você pode auditar cada precedente antes
                de replicar.
              </p>
              <ul className="muted small">
            ...
            <div className="info-card">
              ...
              <p>
                Não coletamos dados sensíveis. O cálculo de similaridade e impacto é feito apenas sobre textos públicos
                e agregados.
              </p>
              <ul className="muted small">
            ...
            <div className="info-card">
              ...
              <p>
                Precisa de mais transparência ou quer enviar novos indicadores? Entre em contato para priorizarmos
                ajustes.
              </p>
              <ul className="muted small">
