...
Ementa: & \textit{DISPÕE SOBRE A IMPLANTAÇÃO DE ESTUFAS COM HORTAS PRODUZIDAS COM GARRAFAS PET NAS ESCOLAS MUNICIPAIS DE MARABÁ E DA OUTRAS PROVIDÊNCIAS.} \\
\addlinespace[4pt]
Ação: & \textit{Instalar estufas com hortas produzidas com garrafas pet nas escolas municipais.} \\
\end{tabular}
\end{table}
