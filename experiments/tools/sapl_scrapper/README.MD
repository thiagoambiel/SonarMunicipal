...
# Execucao mais leve (sem ultima tramitacao)
python sapl_scrapper.py --in-jsonl sapl_hosts.jsonl --no-tramitacao
```
...
- `--no-tramitacao`: desativa a consulta de ultima tramitacao.
