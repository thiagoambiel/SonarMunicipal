...
| **Dataset** (benchmark TREC-style + corpus de 241k ações) | CC-BY-4.0 | [Hugging Face Hub](https://huggingface.co/datasets/thiagoambiel/sonar-municipal-pl-actions) · Zenodo `10.5281/zenodo.<DS-CONCEPT-PREENCHER>` |
| **Modelo** PTT5-v2 ementa→ação | Apache-2.0 | [Hugging Face Hub](https://huggingface.co/thiagoambiel/sonar_municipal_ptt5_ementa2action) · Zenodo `10.5281/zenodo.<MD-CONCEPT-PREENCHER>` |
